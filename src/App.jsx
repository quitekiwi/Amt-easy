    ...
    <div style={{ minHeight: "100vh", background: "#1e2a28", fontFamily: "'DM Sans', sans-serif", color: "#d6c9b0", padding: "0" }}>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .amt-about-text:last-child { margin-bottom: 0; }
      ...
      <div className="amt-about">
        <div className="amt-about-card">
          ...
          <p className="amt-about-text">Amt-Easy uses AI to instantly translate these documents into plain language — giving you a clear summary, your deadlines, what you need to bring, and who to contact. Available in 10 languages.</p>
