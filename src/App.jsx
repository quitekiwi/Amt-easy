    ...
    <div style={{ minHeight: "100vh", background: "#1e2a28", fontFamily: "'DM Sans', sans-serif", color: "#d6c9b0", padding: "0" }}>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .amt-lang-dropdown { position: absolute; top: calc(100% + 6px); left: 0; background: #243330; border: 1px solid #2e3f3c; border-radius: 8px; overflow: hidden; z-index: 200; min-width: 160px; box-shadow: 0 8px 32px rgba(0,0,0,0.5); }
        ...
        .amt-disclaimer { margin-top: 32px; padding: 14px 18px; background: transparent; border: 1px solid #2e3f3c; border-radius: 8px; font-size: 11px; color: #3a4f4c; line-height: 1.6; text-align: center; }
      ...
      <div className="amt-main">
        <div className="amt-card">
          ...
          <div className="amt-controls">
            ...
            <button className="amt-analyze-btn" onClick={analyze} disabled={loading || !input.trim()}>
        ...
        {result && !loading && (
          <div className="amt-card amt-result">
            ...
            <div className="amt-disclaimer">
              Amt-Easy is an educational tool only. This is not legal advice (Rechtsberatung). Always verify important information with the relevant authority or a qualified advisor.
            </div>
          </div>
        )}
      </div>
